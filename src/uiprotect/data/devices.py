...
if TYPE_CHECKING:
    ...
    from .public_devices import PublicCameraLedSettings, PublicOsdSettings
...
class Light(ProtectMotionDeviceModel):
    ...
    async def set_flood_light_public(self, enabled: bool) -> None:
        ...
        # Public ``update_light_public`` returns a ``PublicLight`` (no private
        # ``light_on_settings``); reflect the just-applied force state locally.
        self.light_on_settings.is_led_force_on = enabled
